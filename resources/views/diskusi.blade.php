					...
					<a href="#" class="list-group-item list-group-item-action border-0">
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1 ml-3">
								XII PPLG 1
								<div class="small"><span class=""></span> Andi, Ucup, Bangjali...</div>
							</div>
						</div>
					</a>
					<a href="#" class="list-group-item list-group-item-action border-0">
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1 ml-3">
								XII PPLG 2
								<div class="small"><span class=""></span> Windah, Upin, Ipin...</div>
							</div>
						</div>
					</a>
                    <a href="#" class="list-group-item list-group-item-action border-0">
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1 ml-3">
								Yadika
								<div class="small"><span class=""></span> Shiva, Ladusing, Jubaedah...</div>
							</div>
						</div>
					</a>
                    <a href="#" class="list-group-item list-group-item-action border-0">
						...
						<div class="d-flex align-items-start">
							...
							<div class="flex-grow-1 ml-3">
								Mahaputra
								<div class="small"><span class=""></span> Kipli, Sudandono, Spongebob...</div>
							</div>
						</div>
					</a>
					...
					<div class="py-2 px-4 border-bottom d-none d-lg-block">
						<div class="d-flex align-items-center py-1">
							...
							<div class="flex-grow-1 pl-3">
								<strong>XII PPLG 1</strong>
								<div class="text-muted small"><em>Andi, Ucup, Santosa, Bangjali, Agus, Subag, Jarjit, Windah, Jupriadi, Sandika</em></div>
							</div>
							<div>
						...
						<div class="chat-messages p-4">
							...
							<div class="chat-message-left pb-4">
								...
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
									<div class="font-weight-bold mb-1">Jarjit</div>
									Dua tiga angin bertiup, saya pun tak tahu
								</div>
							</div>
							...
							<div class="chat-message-left pb-4">
								...
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
									<div class="font-weight-bold mb-1">Jarjit</div>
									Bayar dulu ya 500k nanti dibantuin
								</div>
							</div>
							...
							<div class="chat-message-left pb-4">
								...
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
									<div class="font-weight-bold mb-1"> Agus kece</div>
									emangnya gabisa?
								</div>
							</div>
							...
							<div class="chat-message-left pb-4">
								...
								<div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
									<div class="font-weight-bold mb-1">Agus Kece</div>
									ituteh dikali dulu baru dibagi
								</div>
							</div>
